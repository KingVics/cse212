...
public class TakingTurnsQueueTests
{
    ...
    // Defect(s) Found: 1) PersonQueue.Enqueue used Insert(0,...) adding to the front instead of the back, reversing queue order.
    //                  2) GetNextPerson always re-enqueued everyone (finite people never left the queue).
    ...
    // Expected Result: Bob, Tim, Sue, Bob, Tim, Sue, Tim, Sue, Tim, Tim
    // Defect(s) Found: 1) PersonQueue.Enqueue used Insert(0,...) adding to the front instead of the back, reversing queue order.
    //                  2) GetNextPerson decremented the Turns of infinite-turn people (turns <= 0), modifying a value that should stay unchanged.
    ...
    // Defect(s) Found: No defects found. Exception was thrown correctly with the expected message.

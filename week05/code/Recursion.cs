...
public static class Recursion
{
    ...
    {
        Console.WriteLine($"SumSquaresRecursive({n}) called");
    ...
    public static void WildcardBinary(string pattern, List<string> results)
    {
        ...
        else
        {
            ...
            string newPattern1 = pattern.Remove(index, 1).Insert(index, "0");
            string newPattern2 = pattern.Remove(index, 1).Insert(index, "1");
